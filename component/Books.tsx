...
export function BookA() {
    ...
    const story : IPage[] = [
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/subject.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page8.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page10.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page12.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page14.mp3'))
        },
        {
            imgElement : <Image style={style.image} source={require('../static/book/1/page(15).png')}/>,
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page15.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page17.mp3'))
        },
        {
            imgElement : <Image style={style.image} source={require('../static/book/1/page(18).png')}/>,
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page18.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page20.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page22.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page24.mp3'))
        },
        {
            imgElement : <Image style={style.image} source={require('../static/book/1/page(25).png')}/>,
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page25.mp3'))
        },
        {
        ...
        },
        {
            ...
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page27.mp3'))
        },
        {
            imgElement : <Image style={style.image} source={require('../static/book/1/page(28).png')}/>,
            soundPlay : Audio.Sound.createAsync(require('../static/book/1/sound/page28.mp3'))
        }
    ]    
    ...
    function nextPage() {        
        setNow({...story[page+1]});
        const temp = {...story[page+1]}
        temp.soundPlay ? temp.soundPlay
        .then(obj => {
